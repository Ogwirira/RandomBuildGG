    ...
    switch ($mode) {
        case 'enter_email':
            ...
            <section id="form_forgot">
                <form class="form_log" method="post" action="forgot.php?mode=enter_email" class="Form-container">
                    ...
                    <div >   
                    <label class="label" for="pseudo">Entrez votre Email</label>
        ...
        case 'enter_code':
            ...
            <section id="form_forgot">
                <form class="form_log" method="post" action="forgot.php?mode=enter_code">
                    ...
                    <input class="input" type="text" name="code" placeholder="12345">
        ...
        case 'enter_password':
            ...
            <section id="form_forgot">
                <form class="form_log" method="post" action="forgot.php?mode=enter_password">
                    ...
                    <label class="label" for="pseudo">   Entrez un nouveau mot de passe</label>
                    <input class="input" type="password" name="password" placeholder="Nouveau mot de passe">
                    <input class="input" type="password" name="password2" placeholder="Retaper le mot de passe">
                    <input type="submit" value="Continuer" class="valider">
                </form>
            </section>
            <?php
